...
<form action="" method="post">
    <center>
        <h2>View Admission Inquiries</h2>
        <br>
        ...
        <table border="2" cellspacing="6" class="displaycontent" width="1000" height="120" style="border:4px solid lightblue;" align="center">
            <tr>
                ...
                <th bgcolor=white><font color=black size=2>Fees details</font></th>
                <th bgcolor=white><font color=black size=2>Message</font></th>
                <th bgcolor=white><font color=black size=2>Action</font></th>
            </tr>

          <?php

    $query = "SELECT * FROM admission_inquiries where email='" . $_SESSION['email'] . "'";
    $result = mysql_query($query) or die(mysql_error());
    while ($row = mysql_fetch_assoc($result)) {
?>

                <tr>
                    <td bgcolor=white><b><font color=black size=2><?php echo $row['aid']; ?></font></b></td>
                    ...
                    <td bgcolor=white><b><font color=black size=2><?php echo $row['phone']; ?></font></b></td>
                    <td bgcolor=white><b><font color=black size=2><?php echo $row['standard']; ?></font></b></td>
                    <td bgcolor=white><b><font color=black size=2><?php echo $row['fees_details']; ?></font></b></td>
                    <td bgcolor=white><b><font color=black size=2><?php echo $row['message']; ?></font></b></td>
                    <td bgcolor=white><b><font color=black size=2><?php echo $row['action']; ?></font></b></td>
                </tr>
            <?php } ?>
        </table>
    </center>
