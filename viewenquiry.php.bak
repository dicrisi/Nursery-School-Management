...
<br>
	...
	<?php
$query = "SELECT * FROM admission_inquiries WHERE action='Requested' ";
			...
			<td bgcolor=white><b><font color=black size=2><?php echo $row['standard']; ?></font><b></td>
				<td bgcolor=white><b><font color=black size=2><?php echo $row['fees_details']; ?></font><b></td>
					<td bgcolor=white><b><font color=black size=2><?php echo $row['message']; ?></font><b></td>
						 ...
						 <td  bgcolor=white><font color=black size=2 ><a href="status.php?select=<?php echo $row['aid'];?>">Status</a></font></td>
